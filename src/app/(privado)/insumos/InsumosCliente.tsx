  ...
  return (
    <>
      <div className="flex justify-between items-center mb-4">
        <p className="text-sm text-gray-500">{insumos.length} insumos registrados</p>
      ...
      {insumos.length === 0 ? (
        ...
        <TablaInsumos insumos={insumos} onEditar={abrirEditar} />
      )}
      ...
      <Dialog open={modalAbierto} onOpenChange={setModalAbierto}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            <DialogTitle>
              {editando ? '✏️ Editar Insumo' : '➕ Nuevo Insumo'}
            </DialogTitle>
          </DialogHeader>
